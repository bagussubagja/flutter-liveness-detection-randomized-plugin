                  ...
                  child: Column(
                    children: [
                      ListTile(
                        ...
                        title: Text(
                          widget.locale == "en" ? "Sufficient Lighting" : "Pencahayaan yang cukup",
                          style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: widget.isDarkMode ? Colors.white : Colors.black),
                        ),
                      ),
                      ListTile(
                        ...
                        subtitle: Text(
                          widget.locale == "en"
                              ...
                              : "Pegang perangkat sejajar dengan tinggi mata dan lihat lurus kedepan ke arah kamera, jika memakai kacamata usahakan dilepas untuk memudahkan pengenalan",
                          style: TextStyle(color: widget.isDarkMode ? Colors.white : Colors.black),
                        ),
                        title: Text(
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          widget.locale == "en"
                              ? "The time limit given for the liveness detection system verification process is 60 seconds"
                              : "Batas waktu yang diberikan untuk proses verifikasi sistem deteksi keaktifan adalah 60 detik",
                          style: TextStyle(color: widget.isDarkMode ? Colors.white : Colors.black),
                        ),
                        title: Text(
